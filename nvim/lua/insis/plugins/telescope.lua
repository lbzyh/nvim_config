    ...
    defaults = {
      ...
      mappings = {
        i = {
          ...
          [cfg.keys.results_scrolling_left] = "results_scrolling_left",
          [cfg.keys.results_scrolling_right] = "results_scrolling_right",
          -- history
          ...
          [cfg.keys.preview_scrolling_left] = "preview_scrolling_left",
          [cfg.keys.preview_scrolling_right] = "preview_scrolling_right",
        },
      },
    },
    pickers = {
